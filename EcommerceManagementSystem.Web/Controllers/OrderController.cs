...
using EcommerceManagementSystem.Web.ViewModels;
...
namespace EcommerceManagementSystem.Web.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Index(string userID, string status, int? pageNo)
        {
            ...
            model.Orders = OrderManager.Instance.SearchOrders(userID, status, pageNo.Value, pageSize);
            var totalRecords = OrderManager.Instance.SearchOrdersCount(userID, status);
        ...
        public ActionResult Details(int ID)
        {
            ...
            model.Order = OrderManager.Instance.GetOrderByID(ID);
        ...
        public JsonResult ChangeStatus(string status, int ID)
        {
            ...
            result.Data = new { Success = OrderManager.Instance.UpdateOrderStatus(ID, status) };
